...
@Singleton
public class SaveActionsPreferenceAccess
{

  public static final String PREF_FORMAT = "format"; //$NON-NLS-1$

  public static final String PREF_ORGANIZE_IMPORTS = "organize_imports"; //$NON-NLS-1$
  ...
  public static class Initializer implements IPreferenceStoreInitializer
  {
    ...
    public void initialize(IPreferenceStoreAccess preferenceStoreAccess)
    {
      ...
      store.setDefault(PREF_ORGANIZE_IMPORTS, true);
  ...
  {
    final var preferenceStore = preferenceStoreAccess.getWritablePreferenceStore(context);
    preferenceStore.setValue(PREF_ORGANIZE_IMPORTS, enabled);
  }
