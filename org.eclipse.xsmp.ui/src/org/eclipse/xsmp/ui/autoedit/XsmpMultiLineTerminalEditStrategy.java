...
/**
 * This strategy applies auto edits when typing a newline character within a
 * block (denoted by a start and end terminal).
 */
public class XsmpMultiLineTerminalEditStrategy extends MultiLineTerminalsEditStrategy
{
  ...
  public static class Factory extends MultiLineTerminalsEditStrategy.Factory
  {
    ...
    @Inject
    private MembersInjector<XsmpMultiLineTerminalEditStrategy> injector;

    /**
     * {@inheritDoc}
     */
    @Override
    public XsmpMultiLineTerminalEditStrategy newInstance(String leftTerminal,
            ...
            String indentationString, String rightTerminal, boolean nested)
    {
      indentationString = indentationString == null ? indentationInformation.getIndentString()
              : indentationString;
      final var strategy = new XsmpMultiLineTerminalEditStrategy(leftTerminal, indentationString,
   ...
   * @param nested
   */
  public XsmpMultiLineTerminalEditStrategy(String leftTerminal, String indentationString,
