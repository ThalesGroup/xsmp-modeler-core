...
public class XsmpcatFoldingRegionProvider extends DefaultFoldingRegionProvider
{
  /**
   * {@inheritDoc}
   */
          ...
          IFoldingRegionAcceptor<ITextRegion> foldingRegionAcceptor, boolean initiallyFolded)
  {
    ...
    if (eObject instanceof Metadatum)
    {
      computeObjectFolding((Metadatum) eObject, foldingRegionAcceptor, initiallyFolded);
    }
    else if (eObject instanceof NamedElement)
    {
      computeObjectFolding((NamedElement) eObject, foldingRegionAcceptor, initiallyFolded);
    }
    else
    {
