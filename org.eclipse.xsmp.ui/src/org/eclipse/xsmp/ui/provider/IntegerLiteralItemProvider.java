 ...
 * {@link org.eclipse.xsmp.xcatalogue.IntegerLiteral} object.
 */
public class IntegerLiteralItemProvider extends ExpressionItemProvider
{
   ...
   */
  @Inject
  public IntegerLiteralItemProvider(XcatalogueItemProviderAdapterFactory adapterFactory)
  {
  ...
  {
    final var label = ((IntegerLiteral) object).getText();
    final var styledLabel = new StyledString();
    if (label == null || label.length() == 0)
    {
      styledLabel.append(getString("_UI_IntegerLiteral_type"), StyledString.Style.QUALIFIER_STYLER);
    }
    else
    {
      styledLabel.append(getString("_UI_IntegerLiteral_type"), StyledString.Style.QUALIFIER_STYLER)
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case XcataloguePackage.INTEGER_LITERAL__TEXT:
        // case XcataloguePackage.INTEGER_LITERAL__VALUE:
        fireNotifyChanged(
