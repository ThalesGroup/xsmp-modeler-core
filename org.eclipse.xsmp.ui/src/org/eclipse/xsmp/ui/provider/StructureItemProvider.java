...
public class StructureItemProvider extends ValueTypeItemProvider
{
   ...
   */
  @Inject
  public StructureItemProvider(XcatalogueItemProviderAdapterFactory adapterFactory)
  {
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case XcataloguePackage.STRUCTURE__MEMBER:
        fireNotifyChanged(
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors
            .add(createChildParameter(XcataloguePackage.Literals.NAMED_ELEMENT_WITH_MEMBERS__MEMBER,
                    XcatalogueFactory.eINSTANCE.createConstant()));
  ...
  protected boolean canContain(EObject owner, EStructuralFeature feature, Object value)
  {
    ...
    {
      return value instanceof Constant || value instanceof Field;
    }
