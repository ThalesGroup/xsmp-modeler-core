...
/**
 * A specialized builder participant that check that the builder is enabled for
 * the provided project Support for output configuration without a
 * default_output
 */
public class XsmpBuilderParticipant extends BuilderParticipant
{
