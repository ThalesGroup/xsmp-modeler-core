...
@ProjectTemplate(label="ESA CDK Project", icon="project_template.png", description="<p><b>Create a new ESA CDK Project</b></p>")
final class EsaCdkProject {
	...
	override generateProjects(IProjectGenerator generator) {
		...
		generator.generate(new XsmpcatProjectFactory() {
			...
			profile = extensionManager.getProfile("org.eclipse.xsmp.profile.esa-cdk")
