...
public class XlinkSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case XlinkPackage.SIMPLE_LINK_BASE:
			{
				SimpleLinkBase simpleLinkBase = (SimpleLinkBase)theEObject;
				T result = caseSimpleLinkBase(simpleLinkBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XlinkPackage.SIMPLE_LINK:
			{
				SimpleLink simpleLink = (SimpleLink)theEObject;
				T result = caseSimpleLink(simpleLink);
				if (result == null) result = caseSimpleLinkBase(simpleLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XlinkPackage.SIMPLE_LINK_REF:
			{
				SimpleLinkRef simpleLinkRef = (SimpleLinkRef)theEObject;
				T result = caseSimpleLinkRef(simpleLinkRef);
				if (result == null) result = caseSimpleLinkBase(simpleLinkRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XlinkPackage.XLINK_DOCUMENT:
			{
				XlinkDocument xlinkDocument = (XlinkDocument)theEObject;
				T result = caseXlinkDocument(xlinkDocument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSimpleLinkBase(SimpleLinkBase object)
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSimpleLinkRef(SimpleLinkRef object)
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseXlinkDocument(XlinkDocument object)
	{
		return null;
	}
