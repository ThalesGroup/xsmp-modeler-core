 ...
 * ******************************************************************************
 */
package org.eclipse.xsmp.smp.xlink.util;
...
public class XlinkAdapterFactory extends AdapterFactoryImpl
{
	...
	protected XlinkSwitch<Adapter> modelSwitch =
		new XlinkSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseXlinkDocument(XlinkDocument object)
			{
				return createXlinkDocumentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xsmp.smp.xlink.SimpleLink <em>Simple Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xsmp.smp.xlink.XlinkDocument <em>Document</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXlinkDocumentAdapter()
	{
		return null;
	}
