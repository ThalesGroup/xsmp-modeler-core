 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xsmp.smp.core.types.impl.AssociationImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends VisibilityElementImpl implements Association
{
	/**
	...
	public NotificationChain basicSetType(ElementReference<LanguageType> newType, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.ASSOCIATION__TYPE, oldType, newType);
	...
	public void setType(ElementReference<LanguageType> newType)
	{
		if (newType != type)
		{
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.ASSOCIATION__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.ASSOCIATION__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.ASSOCIATION__TYPE, newType, newType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case TypesPackage.ASSOCIATION__TYPE:
