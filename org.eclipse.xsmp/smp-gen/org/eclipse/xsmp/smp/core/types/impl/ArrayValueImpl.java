 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xsmp.smp.core.types.impl.ArrayValueImpl#getItemValue <em>Item Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayValueImpl extends ValueImpl implements ArrayValue
{
	 ...
	 * @ordered
	 */
	protected EList<Value> itemValue;
	...
	{
		return TypesPackage.Literals.ARRAY_VALUE;
	}
	 ...
	 */
	@Override
	public EList<Value> getItemValue()
	{
		if (itemValue == null)
		{
			itemValue = new EObjectContainmentEList<Value>(Value.class, this, TypesPackage.ARRAY_VALUE__ITEM_VALUE);
		}
		return itemValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case TypesPackage.ARRAY_VALUE__ITEM_VALUE:
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case TypesPackage.ARRAY_VALUE__ITEM_VALUE:
				getItemValue().clear();
				getItemValue().addAll((Collection<? extends Value>)newValue);
				return;
		}
