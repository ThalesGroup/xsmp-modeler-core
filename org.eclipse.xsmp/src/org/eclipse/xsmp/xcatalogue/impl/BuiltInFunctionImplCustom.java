 ...
 * @author daveluy
 */
public class BuiltInFunctionImplCustom extends BuiltInFunctionImpl
{
  @Override
  public Expression solve(ValidationMessageAcceptor acceptor)
  {
    final var solver = ExpressionSolver.functionMappings.get(getName());
    if (solver == null)
    {
      acceptor.acceptError("Unknown builtin function '" + getName() + "'",
