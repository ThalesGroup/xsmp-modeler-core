...
import org.eclipse.xsmp.ide.server.symbol.XsmpDocumentSymbolDeprecationInfoProvider;
...
public class XsmpServerModule extends AbstractModule
{
  ...
  protected void configure()
  {
    ...
    bind(IMultiRootWorkspaceConfigFactory.class).to(XsmpMultiProjectWorkspaceConfigFactory.class);
    ...
    bind(DocumentSymbolDeprecationInfoProvider.class)
            .to(XsmpDocumentSymbolDeprecationInfoProvider.class);
