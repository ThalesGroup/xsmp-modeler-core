 ...
 */
public class ExpressionControlSWTRendererService implements EMFFormsDIRendererService<VControl>
{
  @Inject
  ...
  public double isApplicable(VElement vElement, ViewModelContext viewModelContext)
  {
    ...
    {
      final var eStructuralFeature = EReference.class.cast(valueProperty.getValueType());
